...
window.onscroll = () => {
  ...
  if (window.scrollY > 0) {
    ...
    document.getElementById('img-logo').src = '../images/logo/logo-dark-v1.svg';
  } else {
...
popupWhatsApp = () => {
  ...
  sendBtn.addEventListener("click", () => {
    ...
    window.open('https://wa.me/573123256313?text=' + relmsg, '_blank');
...
/* sendOrder = () => { */
  ...
  sendOrderBtn.addEventListener("click", () => {
    ...
    if (name == null || tel == null || dir == null 
     ...
     window.open('https://wa.me/573123256313?text='+ relmsg + "%0a"
    + "---------------------------------" + "%0a"
    + "       DATOS DEL PEDIDO          " + "%0a"
    + "---------------------------------" + "%0a"
    + carritoEnTexto + "%0a"
